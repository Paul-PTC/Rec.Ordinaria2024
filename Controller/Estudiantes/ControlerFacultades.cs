...
{
    internal class ControlerFacultades
    {
        Facultades objvista;
        public ControlerFacultades(Facultades vista)
        {
            objvista = vista;
        ...
        public void cargarDTG()
        {
            ...
            objvista.dgvEstudiantes.DataSource = ds.Tables["Facultades"];
        }
        public void RegistrarEstudiante(object sender, EventArgs e)
        {
            ...
            data.NombreFacultad = objvista.txtNombres.Text.Trim();
        ...
        public void ActualizarEstudiante(object sender, EventArgs e)
        {
            DAOFacultades data = new DAOFacultades();
            //Guardar en los atributos del DTO todos los valores contenidos en los componentes del formulario
            data.IdFacultad = int.Parse(objvista.txtID.Text.Trim().ToString());
            data.NombreFacultad = objvista.txtNombres.Text.Trim();
